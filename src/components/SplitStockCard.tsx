...
export default function SplitStockCard({ info, latestPrice }: SplitStockCardProps) {
  ...
  return (
    <div className="relative mx-4 my-6">
      <div className="relative backdrop-blur-sm rounded-2xl overflow-hidden border-2 border-white shadow-[0_0_15px_rgba(255,255,255,0.5),0_0_30px_rgba(59,130,246,0.4),inset_0_0_15px_rgba(255,255,255,0.1)]">
