...
export default function ScrollingHistoryData({ prices, stockName }: ScrollingHistoryDataProps) {
  ...
  return (
    <div className="mx-4 my-6">
      <div className="backdrop-blur-sm rounded-2xl overflow-hidden border-2 border-white shadow-[0_0_15px_rgba(255,255,255,0.5),0_0_30px_rgba(59,130,246,0.4),inset_0_0_15px_rgba(255,255,255,0.1)]">
        <div className="bg-blue-900/30 backdrop-blur-sm px-4 py-3 border-b-2 border-white/50">
        ...
        <div
          ref={containerRef}
          className="relative h-[240px] overflow-hidden bg-blue-900/20"
        >
          <div
